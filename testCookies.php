...
if(isset($_POST["add_to_cart"]))
{
 ...
 header("location:testCart.php?success=1");
}
...
if(isset($_GET["action"]))
{
 if($_GET["action"] == "delete")
 {
  ...
  foreach($cart_data as $keys => $values)
  {
   if($cart_data[$keys]['item_id'] == $_GET["id"])
   {
    ...
    $item_data = json_encode($cart_data);
    setcookie("shopping_cart", $item_data, time() + (86400 * 30));
    header("location:testCart.php?remove=1");
   }
  }
 }
 if($_GET["action"] == "clear")
 {
  ...
  header("location:testCart.php?clearall=1");
 }
}
  ...
  <div class="container">
   ...
   ?>
    <tr>
     ...
     <td><a href="testCookies.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
    </tr>
   <?php 
