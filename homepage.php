...
$connect = new PDO("mysql:host=localhost;dbname=users", "root", ""); //dbname changed from web to users, be sure to change this to match
  ...
  <div class="main">
    <div class="column menu active">
      <div id="myBtnContainer">
        <form method="post">
          <!-- <button class="btngroup" >Show all</button>
          <button class="btngroup" >Produce</button>
          <button class="btngroup" >Dairy & Eggs</button>
          <button class="btngroup" >Meat</button>
          <button class="btngroup" >Snacks</button> -->
          <input type="submit" name="Show all" class="btngroup" value="Show all" />
          <input type="submit" name="Produce" class="btngroup" value="Produce" />

          <input type="submit" name="Dairy & Eggs" class="btngroup" value="Dairy & Eggs" />

          <input type="submit" name="Meat" class="btngroup" value="Meat" />

          <input type="submit" name="Snacks" class="btngroup" value="Snacks" />
        </form>
      </div>
    </div>
    ...
    <div class="row">
                    ...
                    <div class="card h-60">
                        ...
                        <img src="<?php echo $all_products["URL_image"]; ?>" class="img-responsive" /><br />

                        <h4 class="text-info"><?php echo $all_products["productName"]; ?></h4>
